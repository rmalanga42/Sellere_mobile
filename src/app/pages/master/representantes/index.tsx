...
export default function Representantes() {
  ...
  useEffect(() => {
    // Substitua 'rgmalanga' pelo username do Master logado
    const masterUsername = 'rgmalanga';

    // Carregar os representantes vinculados ao Master
    axios.get(`${CONFIG.url_api}usuarios/representantes`, {
      params: { master_username: masterUsername },
    })
      .then(response => {
        console.log('Representantes recebidos:', response.data);
...
// ESTAVA FUNCIONANDO PARCIALMENTE
